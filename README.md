...
You can install the released version of `flowcluster` from
[CRAN](https://CRAN.R-project.org/package=flowcluster) with:
...
[GitHub](https://github.com/Hussein-Mahfouz/flowcluster) with:
